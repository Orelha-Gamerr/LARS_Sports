...
@section('page-title', 'Editar Quadras: ' . $quadra->name)
...
<div class="p-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-semibold">Editar Quadras</h1>
    ...
    <div class="bg-white shadow rounded p-6">
        ...
        <form action="{{ route('super-admin.quadras.update', $quadra) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="mb-4 mt-3   ">
                ...
                <select name="disponivel"
                        class="w-full px-3 py-2 border border-gray-300 rounded focus:ring focus:ring-purple-200">
                    <option value="1" {{ old('ativa', $quadra->ativa) ? 'selected' : '' }}>Ativa</option>
                    <option value="0" {{ old('ativa', $quadra->ativa) ? '' : 'selected' }}>Inativa</option>
                </select>
            </div>
