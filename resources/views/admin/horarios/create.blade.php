...
@section('page-title', 'Novo Horário')

@section('admin-content')
<div class="p-6">

    <div class="mb-6">
        <h1 class="text-2xl font-semibold">Criar Horário</h1>
        <p class="text-sm text-gray-500">Adicione um novo horário para uma quadra</p>
    </div>

    <div class="bg-white shadow rounded-lg p-6">

        <form action="{{ route('admin.horarios.store') }}" method="POST" class="space-y-5">
            @csrf
